...
class fe_abilities extends Model
{
    ...
    public function inRole(){
        return $this->belongsToMany('\fe_roles\models\fe_roles', 'fe_role_abilities', 'ability_id', 'role_id');
    }
    ...
    public function user()
    {
        ...
        return $this->morphedByMany('\fe_roles\models\fe_User', 'target','fe_abilities_targets','ability_id','target_id');
    }
}
